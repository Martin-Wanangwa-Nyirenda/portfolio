      ...
      <main className="bg-[url('/image3.png')] bg-repeat-y bg-cover flex flex-col items-center justify-center w-screen min-h-screen">
        <div className="container max-w-5xl mx-auto">
          <section className="flex flex-col justify-center items-center mt-8 md:mt-24">
            ...
            <button className="border-zinc-50 mt-20 border-2 py-3 px-4 font-bold rounded-lg hover:bg-sky-500 text-sm md:text-lg lg:text-lg">
              Find out more
            </button>
          </section>
          ...
          <div className="flex mt-24 items-center">
            ...
            <p className="text-zinc-50 md:w-96 italic text-2xl md:text-4xl lg:text-4xl text-center mx-auto">
          ...
          <div className="flex mt-16 items-center">
            <div className="hidden md:block border-t-4 mr-8 w-full"></div>
            <p className="text-zinc-50 md:w-96 italic text-xl sm:text-2xl md:text-4xl lg:text-4xl text-center">
